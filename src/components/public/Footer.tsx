          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-gray-400">
                <Mail className="w-4 h-4 mt-0.5 shrink-0 text-blue-400" aria-hidden="true" />
                <a href="mailto:hello@gadgetsbytj.com" className="hover:text-white transition-colors">
                  hello@gadgetsbytj.com
                </a>
              </li>
              <li className="flex items-start gap-2 text-sm text-gray-400">
                <Phone className="w-4 h-4 mt-0.5 shrink-0 text-blue-400" aria-hidden="true" />
                <a href="tel:+15551234567" className="hover:text-white transition-colors">
                  +1 (555) 123-4567
                </a>
              </li>
              <li className="flex items-start gap-2 text-sm text-gray-400">
                <MapPin className="w-4 h-4 mt-0.5 shrink-0 text-blue-400" aria-hidden="true" />
